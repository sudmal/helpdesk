...
-- 2. Создаем пользователя с вашим паролем
CREATE USER 'helpdesk'@'localhost' IDENTIFIED BY 'HBiuh7vegfow4efj';

-- 3. Выдаем все привилегии на базу данных helpdesk
GRANT ALL PRIVILEGES ON helpdesk.* TO 'helpdesk'@'localhost';

-- 4. Обновляем таблицу привилегий, чтобы изменения вступили в силу
FLUSH PRIVILEGES;
