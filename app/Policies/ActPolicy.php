...
class ActPolicy
{
     ...
     * бригадир (не своего же акта) или admin, и только пока акт ещё не
     * утверждён. Admin-обход добавлен 2026-08-03 по прямой просьбе
     * пользователя (нужно поправить материалы в закрытом, но не утверждённом
     * акте, когда бригадир недоступен) — до этого был жёстко исключён
     * (2026-07-15, см. память project-acts-feature). Ограничение "не свой
     * акт" для бригадира не менялось.
     */
