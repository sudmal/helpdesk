...
Route::middleware(['auth', 'active'])->group(function () {
    ...
    Route::prefix('connection-requests')->name('connection-requests.')->group(function () {
        ...
        Route::post('/{connectionRequest}/cancel',        [ConnectionRequestController::class, 'cancel'])->name('cancel');
    ...
    Route::middleware('can:manage-settings')->prefix('brigades')->name('brigades.')->group(function () {
        ...
        Route::patch('/{brigade}/toggle-active', [BrigadeController::class, 'toggleActive'])->name('toggle-active');
    });
    ...
    Route::prefix('addresses')->name('addresses.')->group(function () {
        ...
        Route::patch('/rename-city',     [AddressController::class, 'renameCity'])->name('rename-city')->middleware('can:manage-settings');
        Route::patch('/rename-building', [AddressController::class, 'renameBuilding'])->name('rename-building')->middleware('can:manage-settings');
