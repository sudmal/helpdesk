      ...
      <template v-else-if="health.data">
        ...
        <div class="bg-white border border-gray-200 rounded-xl p-3.5">
          ...
          <div v-else class="relative">
            <svg :viewBox="`0 0 ${CHART_W} ${CHART_H}`" preserveAspectRatio="none" class="w-full" style="aspect-ratio: 640 / 200; max-height: 260px"
...
const permissionGroups = [
  ...
  },
  {
    ...
    permissions: [
      ...
      { key: 'acts.process_subscriber_dept', label: 'Виза актов (Абонотдел)', desc: 'Ставить визу со стороны Абонотдела (независимо от ПЭО/Логистики)' },
      { key: 'acts.complete',           label: 'Завершение актов',          desc: 'Отправлять акт в архив со стороны Абонотдела, когда проведены все требуемые стороны' },
    ]
  },
  {
